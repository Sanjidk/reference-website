...
const Skill = () => {
    return (
        <div className="flex flex-col lg:flex-row mt-20 max-w-5xl mx-auto px-5">
            <div className='w-96'> 
                <p className="text-blue-500 font-bold">My Skills...</p>
                <h1 className="text-3xl font-bold my-4">Wildlife Photography, ReactJS, JavaScript, MongoDB, NodeJS </h1>
                <button className="underline decoration-1 underline-offset-8 hover:bg-slate-900 p-1 hover:translate-x-0.5 my-4">My Photography</button>
            </div>
            <div className='w-96'>
